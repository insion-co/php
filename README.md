...
[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-Built%20with%20Fern-brightgreen)](https://buildwithfern.com?utm_source=github&utm_medium=github&utm_campaign=readme&utm_source=Insion%2FPHP)
[![php shield](https://img.shields.io/badge/php-packagist-pink)](https://packagist.org/packages/insion/insion)

The Insion PHP library provides convenient access to the Insion APIs from PHP.
...
try {
    $response = $client->moderateARecord(...);
} catch (InsionApiException $e) {
...
$client = new InsionClient(options: [
    'client' => $customClient
]);
